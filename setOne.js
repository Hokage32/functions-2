...
// CODE HERE
const oneLine = () => 'the first parameter is [parameter1]. The second parameter is [parameter2].'
...
function callback1(string1, string2){
    return string1 + string2
}

function greeting(fN, lN, callback){
    return callback1(fN, lN)
}

// INVOKE 'GREETING FUNCTION' HERE
console.log(greeting('Levi', 'Raoelina'))
...
// CODE HERE
const callBack2 = (totalCost) => console.log(`The new array plus tax = ` , totalCost)
